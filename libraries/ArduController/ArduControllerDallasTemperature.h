#ifndef ArduControllerDallasTemperature_h
#define ArduControllerDallasTemperature_h
...
class ArduControllerDallasTemperature
{
  public:

  ArduControllerDallasTemperature(ArduControllerOneWire *);
